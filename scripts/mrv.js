...
function processLiveData(data){
	...
	for(var i = 0;i<cols1.length;i++){
		if(prev[cols1[i]] == current[cols1[i]]){
			...
			document.getElementById(cols1[i]).innerHTML = '<div class="circle" style="border-color: grey">'+
			'<div class="inner-circle" style="border-color: grey"><div style="margin-top: 30%;" id="' + 'd-'+cols1[i] + '" class="dataValue">' + 
			numberWithCommas(current[cols1[i]].toFixed()) + '</div></div></div>';
		}
	}
...
function processOfficesData(data){
	...
	for(var i = 0;i<cols1.length;i++){
		if(current[cols1[i]] == ''){
			document.getElementById(cols1[i]).innerHTML = '<div class="circle" style="border-color: grey">'+
			'<div class="inner-circle" style="border-color: grey"><div style="margin-top: 30%;" id="' + 'moff-'+cols1[i]+ '" class="dataValue">' + 
			'-' + '</div></div></div>';
		}
		else if(prev[cols1[i]] == current[cols1[i]]){
			document.getElementById(cols1[i]).innerHTML = '<div class="circle" style="border-color: orange">'+
...
function processSummaryData(data){
	...
	var cols2 = ['CO2e_Per_LNG','CO2e_Per_Prod_Lag','CO2e_Per_Prod_MMBTU']
	for(var i = 0;i<cols2.length;i++){
	...
	document.getElementById('CO2e_Per_Prod_Lag_Date').innerHTML = '[ ' + current["months"][dd.getMonth()] + '-' + dd.getFullYear() + ' ]';
	...
	document.getElementById('CO2e_Per_Prod_MMBTU2').innerHTML = numberWithCommas(current['CO2e_Per_Prod_MMBTU'].toFixed(2));	
	document.getElementById('CO2e_Per_LNG_MMBTU2').innerHTML = '<span style="color: red; font-size: 14pt; margin-left: 0%;">&#9650;</span>&nbsp;<span>' + numberWithCommas(current['CO2e_Per_LNG_MMBTU'].toFixed(2)) + '</span>';
	document.getElementById('CO2e_Per_LPG_MMBTU2').innerHTML = numberWithCommas(current['CO2e_Per_LPG_MMBTU'].toFixed(2));
	document.getElementById('CO2e_Per_COND_MMBTU2').innerHTML = numberWithCommas(current['CO2e_Per_COND_MMBTU'].toFixed(2));*/
...
$('#showSummary').on('click',function(){
	window.open('http://wapp-bny.nlng.net/mrv/summary.html', '_blank');
});
...
function refreshPg(){
	...
	var cols1 = ['SPDC_CO2e','TEPNG_CO2e','NAOC_CO2e'];
	var cols2 = ['Waste_CO2e','Mobile_CO2e','Fugitives_CO2e','Flare_CO2e'];
	var cols3 = ['Acid_Gas_CO2e','LHU_CO2e','Trains_CO2e','GTG_CO2e'];
	var cols4 = ['NSML_CO2e','BW_Gas_CO2e','NYK_CO2e','NMM_CO2e','Temile_CO2e','Marine_Partners_CO2e'];
	var cols5 = ['Projects_CO2e'];
	var cols6 = ['PHC_CO2e','ABJ_CO2e','LTO_CO2e','LON_NG_CO2e'];
	var cols7 = ['Aviation_CO2e','Passenger_Boats_CO2e','Tug_Boats_CO2e','Escort_CO2e','Bny_Fleet_CO2e','Non_Bny_Fleet_CO2e'];
	...
	for(var j = 0;j<current["summaryData"].length;j++){
		...
		if(RecordDate.getMonth() == thisDate.getMonth() && RecordDate.getFullYear() == thisDate.getFullYear()){
			for(var i = 0;i<cols1.length;i++){
				...
				//current[cols1[i]+'_Date'] = current["upstreamData"][j]['RecordDate'];
			}
			break;
		}
		else{
	...
	for(var i = 0;i<cols1.length;i++){
		...
		document.getElementById('upstreamDate').innerHTML = '[ ' + current["months"][dd.getMonth()] + '-' + dd.getFullYear() + ' ]';
		if(current[cols1[i]] == '-'){
			document.getElementById(cols1[i]).innerHTML = '<span style="font-size: 14pt; margin-left: 10%;" id="' + 'mup-'+cols1[i]+ '" class="dataValue">' + numberWithCommas(current[cols1[i]]) + '</span><br>';
		}
		else if(prev[cols1[i]] == current[cols1[i]]){
			document.getElementById(cols1[i]).innerHTML = '<span style="color: orange; font-size: 14pt; margin-left: 10%;">&#9673; </span>'+
			'<span id="' + 'mup-'+cols1[i]+ '" class="dataValue">' + numberWithCommas(current[cols1[i]]) + '</span><br>';
		}
		else if(prev[cols1[i]] < current[cols1[i]]){
			document.getElementById(cols1[i]).innerHTML = '<span style="color: red; font-size: 14pt; margin-left: 10%;">&#9650; </span>'+
			'<span id="' + 'mup-'+cols1[i]+ '" class="dataValue">' + numberWithCommas(current[cols1[i]]) + '</span><br>';
	...
	for(var j = 0;j<current["summaryData"].length;j++){
		...
		if(RecordDate.getMonth() == thisDate.getMonth() && RecordDate.getFullYear() == thisDate.getFullYear()){
			for(var i = 0;i<cols2.length;i++){
				if(current["summaryData"][j][cols2[i]] == 'nan' && current["summaryData"][j][cols2[i]] == ''){
					current[cols2[i]] = '-';
					prev[cols2[i]] = '-';
				}
				else{
					current[cols2[i]] = (parseFloat(current["summaryData"][j][cols2[i]])).toFixed();
					prev[cols2[i]] = (parseFloat(current["summaryData"][j-1][cols2[i]])).toFixed();
				}
				//current[cols2[i]+'_Date'] = current["upstreamData"][j]['RecordDate'];
			}
			break;
		}
		else{
			for(var i = 0;i<cols2.length;i++){
				current[cols2[i]] = '-';
				prev[cols2[i]] = '-';
				current[cols2[i]+'_Date'] = thisDate;
			}
		}
	}
	for(var i = 0;i<cols2.length;i++){
		...
		document.getElementById('plantDate').innerHTML = '[ ' + current["months"][dd.getMonth()] + '-' + dd.getFullYear() + ' ]';
		if(current[cols2[i]] == '-'){
			document.getElementById(cols2[i]).innerHTML = '<span style="font-size: 14pt; margin-left: 0%;" id="' + 'mpl-'+cols2[i]+ '" class="dataValue">' + numberWithCommas(current[cols2[i]]) + '</span><br>';
		}
		else if(prev[cols2[i]] == current[cols2[i]]){
			document.getElementById(cols2[i]).innerHTML = '<span style="color: orange; font-size: 14pt; margin-left: 0%;">&#9673; </span>'+
			'<span id="' + 'mpl-'+cols2[i]+ '" class="dataValue">' + numberWithCommas(current[cols2[i]]) + '</span><br>';
		}
		else if(prev[cols2[i]] < current[cols2[i]]){
			document.getElementById(cols2[i]).innerHTML = '<span style="color: red; font-size: 14pt; margin-left: 0%;">&#9650; </span>'+
			'<span id="' + 'mpl-'+cols2[i]+ '" class="dataValue">' + numberWithCommas(current[cols2[i]]) + '</span><br>';
	...
	for(var j = 0;j<current["summaryData"].length;j++){
		...
		if(RecordDate.getMonth() == thisDate.getMonth() && RecordDate.getFullYear() == thisDate.getFullYear()){
			for(var i = 0;i<cols3.length;i++){
				if(current["summaryData"][j][cols3[i]] == 'nan' && current["summaryData"][j][cols3[i]] == ''){
					current[cols3[i]] = '-';
					prev[cols3[i]] = '-';
				}
				else{
					current[cols3[i]] = (parseFloat(current["summaryData"][j][cols3[i]])).toFixed();
					prev[cols3[i]] = (parseFloat(current["summaryData"][j-1][cols3[i]])).toFixed();
				}
				//current[cols3[i]+'_Date'] = current["upstreamData"][j]['RecordDate'];
			}
			break;
		}
		else{
			for(var i = 0;i<cols3.length;i++){
				current[cols3[i]] = '-';
				prev[cols3[i]] = '-';
				current[cols3[i]+'_Date'] = thisDate;
			}
		}
	}
	for(var i = 1;i<cols3.length;i++){
		var dd = new Date(current[cols3[i]+'_Date'])
		document.getElementById('plantDate2').innerHTML = '[ ' + current["months"][dd.getMonth()] + '-' + dd.getFullYear() + ' ]';
		if(current[cols3[i]] == '-'){
			document.getElementById(cols3[i]).innerHTML = '<div class="circle" style="border-color: grey">'+
			'<div class="inner-circle" style="border-color: grey"><div style="margin-top: 30%;" id="' + 'd-'+cols3[i] + '" class="dataValue">' + 
			numberWithCommas(current[cols3[i]]) + '</div></div></div>';
		}
		else if(prev[cols3[i]] == current[cols3[i]]){
			document.getElementById(cols3[i]).innerHTML = '<div class="circle" style="border-color: orange">'+
			'<div class="inner-circle" style="border-color: orange"><div style="margin-top: 30%;" id="' + 'd-'+cols3[i] + '" class="dataValue">' + 
			numberWithCommas(current[cols3[i]]) + '</div></div></div>';
		}
		else if(prev[cols3[i]] < current[cols3[i]]){
			document.getElementById(cols3[i]).innerHTML = '<div class="circle" style="border-color: red">'+
			'<div class="inner-circle" style="border-color: red"><div style="margin-top: 30%;" id="' + 'd-'+cols3[i] + '" class="dataValue">' + 
			numberWithCommas(current[cols3[i]]) + '</div></div></div>';
		}
		else if(prev[cols3[i]] > current[cols3[i]]){
			document.getElementById(cols3[i]).innerHTML = '<div class="circle" style="border-color: green">'+
			'<div class="inner-circle" style="border-color: green"><div style="margin-top: 30%;" id="' + 'd-'+cols3[i] + '" class="dataValue">' + 
			numberWithCommas(current[cols3[i]]) + '</div></div></div>';
		}
	}

	if(current['Acid_Gas_CO2e'] == '-'){
		document.getElementById('Acid_Gas_CO2').innerHTML = '<div class="circle" style="border-color: grey">'+
		'<div class="inner-circle" style="border-color: grey"><div style="margin-top: 30%;" id="' + 'd-'+ 'Acid_Gas_CO2' + '" class="dataValue">' + 
		numberWithCommas(current['Acid_Gas_CO2e']) + '</div></div></div>';
	}
	else if(prev['Acid_Gas_CO2e'] == current['Acid_Gas_CO2e']){
		document.getElementById('Acid_Gas_CO2').innerHTML = '<div class="circle" style="border-color: orange">'+
		'<div class="inner-circle" style="border-color: orange"><div style="margin-top: 30%;" id="' + 'd-'+cols3[i] + '" class="dataValue">' + 
		numberWithCommas(current['Acid_Gas_CO2e']) + '</div></div></div>';
	}
	else if(prev['Acid_Gas_CO2e'] < current['Acid_Gas_CO2e']){
		document.getElementById('Acid_Gas_CO2').innerHTML = '<div class="circle" style="border-color: red">'+
		'<div class="inner-circle" style="border-color: red"><div style="margin-top: 30%;" id="' + 'd-'+cols3[i] + '" class="dataValue">' + 
		numberWithCommas(current['Acid_Gas_CO2e']) + '</div></div></div>';
	}
	else if(prev['Acid_Gas_CO2e'] > current['Acid_Gas_CO2e']){
		document.getElementById('Acid_Gas_CO2').innerHTML = '<div class="circle" style="border-color: green">'+
		'<div class="inner-circle" style="border-color: green"><div style="margin-top: 30%;" id="' + 'd-'+cols3[i] + '" class="dataValue">' + 
		numberWithCommas(current['Acid_Gas_CO2e']) + '</div></div></div>';
	}

	/*for(var j = 0;j<current["shipData"].length;j++){
		var RecordDate = new Date(current["shipData"][j]['RecordDate']);
		if(RecordDate.getMonth() == thisDate.getMonth() && RecordDate.getFullYear() == thisDate.getFullYear()){
			for(var i = 0;i<cols4.length;i++){
				if(current["shipData"][j][cols4[i]] == 'nan'){
					current[cols4[i]] = '-';
					prev[cols4[i]] = '-';
				}
				else{
					current[cols4[i]] = (parseFloat(current["shipData"][j][cols4[i]])).toFixed();
					prev[cols4[i]] = (parseFloat(current["shipData"][j-1][cols4[i]])).toFixed();
				}
			}
			break;
		}
			...
			for(var i = 0;i<cols4.length;i++){
				current[cols4[i]] = '-';
				prev[cols4[i]] = '-';
				current[cols4[i]+'_Date'] = thisDate;
			}
		}
	}
	for(var i = 0;i<cols4.length;i++){
		var dd = new Date(current[cols4[i]+'_Date'])
		document.getElementById('shipDate').innerHTML = '[ ' + current["months"][dd.getMonth()] + '-' + dd.getFullYear() + ' ]';
		if(current[cols4[i]] == '-'){
			document.getElementById(cols4[i]).innerHTML = '<span id="' + 'mup-'+cols4[i]+ '" class="dataValue2">' + numberWithCommas(current[cols4[i]]) + '</span>';
		}
		else if(prev[cols4[i]] == current[cols4[i]]){
			document.getElementById(cols4[i]).innerHTML = '<span style="color: orange; font-size: 14pt; margin-left: 10%;">&#9673; </span>'+
			'<span id="' + 'mpl-'+cols4[i]+ '" class="dataValue">' + numberWithCommas(current[cols4[i]]) + '</span><br>';
		}
		else if(prev[cols4[i]] < current[cols4[i]]){
			document.getElementById(cols4[i]).innerHTML = '<span style="color: red; font-size: 14pt; margin-left: 10%;">&#9650; </span>'+
			'<span id="' + 'mpl-'+cols4[i]+ '" class="dataValue">' + numberWithCommas(current[cols4[i]]) + '</span><br>';
		}
		else if(prev[cols4[i]] > current[cols4[i]]){
			document.getElementById(cols4[i]).innerHTML = '<span style="color: green; font-size: 14pt; margin-left: 10%;">&#9660; </span>'+
			'<span id="' + 'mpl-'+cols4[i]+ '" class="dataValue">' + numberWithCommas(current[cols4[i]]) + '</span><br>';
		}
	}*/

	for(var j = 0;j<current["projectsData"].length;j++){
		var RecordDate = new Date(current["projectsData"][j]['RecordDate']);
		if(RecordDate.getMonth() == thisDate.getMonth() && RecordDate.getFullYear() == thisDate.getFullYear()){
			for(var i = 0;i<cols5.length;i++){
				if(current["projectsData"][j][cols5[i]] == 'nan' && current["projectsData"][j][cols5[i]] == ''){
					current[cols5[i]] = '-';
					prev[cols5[i]] = '-';
				}
				else{
					current[cols5[i]] = (parseFloat(current["projectsData"][j][cols5[i]])).toFixed();
					prev[cols5[i]] = (parseFloat(current["projectsData"][j-1][cols5[i]])).toFixed();
				}
			}
			break;
		}
			...
			for(var i = 0;i<cols5.length;i++){
				current[cols5[i]] = '-';
				prev[cols5[i]] = '-';
				current[cols5[i]+'_Date'] = thisDate;
			}
		}
	}
	for(var i = 0;i<cols5.length;i++){
		var dd = new Date(current[cols5[i]+'_Date'])
		document.getElementById('projDate').innerHTML = '[ ' + current["months"][dd.getMonth()] + '-' + dd.getFullYear() + ' ]';
		if(current[cols5[i]] == '-'){
			document.getElementById(cols5[i]).innerHTML = '<span style="font-size: 14pt; margin-left: 30%;" id="' + 'mp-'+cols5[i]+ '" class="dataValue2">' + numberWithCommas(current[cols5[i]]) + '</span>';
		}
		else if(prev[cols5[i]] == current[cols5[i]]){
			document.getElementById(cols5[i]).innerHTML = '<span style="color: orange; font-size: 14pt; margin-left: 30%;">&#9673; </span>'+
			'<span id="' + 'mp-'+cols5[i]+ '" class="dataValue">' + numberWithCommas(current[cols5[i]]) + '</span>';
		}
		else if(prev[cols5[i]] < current[cols5[i]]){
			document.getElementById(cols5[i]).innerHTML = '<span style="color: red; font-size: 14pt; margin-left: 30%;">&#9650; </span>'+
			'<span id="' + 'mp-'+cols5[i]+ '" class="dataValue">' + numberWithCommas(current[cols5[i]]) + '</span>';
		}
		else if(prev[cols5[i]] > current[cols5[i]]){
			document.getElementById(cols5[i]).innerHTML = '<span style="color: green; font-size: 14pt; margin-left: 30%;">&#9660; </span>'+
			'<span id="' + 'mp-'+cols5[i]+ '" class="dataValue">' + numberWithCommas(current[cols5[i]]) + '</span>';
		}
	}

	for(var j = 0;j<current["officeData"].length;j++){
		var RecordDate = new Date(current["officeData"][j]['RecordDate']);
		if(RecordDate.getMonth() == thisDate.getMonth() && RecordDate.getFullYear() == thisDate.getFullYear()){
			for(var i = 0;i<cols6.length;i++){
				if(current["officeData"][j][cols6[i]] == 'nan' && current["officeData"][j][cols6[i]] == ''){
					current[cols6[i]] = '-';
					prev[cols6[i]] = '-';
				}
				else{
					current[cols6[i]] = (parseFloat(current["officeData"][j][cols6[i]])).toFixed();
					prev[cols6[i]] = (parseFloat(current["officeData"][j-1][cols6[i]])).toFixed();
				}
			}
			break;
		}
			...
			for(var i = 0;i<cols6.length;i++){
				current[cols6[i]] = '-';
				prev[cols6[i]] = '-';
				current[cols6[i]+'_Date'] = thisDate;
			}
		}
	}
	for(var i = 0;i<cols6.length;i++){
		var dd = new Date(current[cols6[i]+'_Date'])
		document.getElementById('esdDate').innerHTML = '[ ' + current["months"][dd.getMonth()] + '-' + dd.getFullYear() + ' ]';
		if(current[cols6[i]] == '-'){
			document.getElementById(cols6[i]).innerHTML = '<div class="circle" style="border-color: grey">'+
			'<div class="inner-circle" style="border-color: grey"><div style="margin-top: 30%;" id="' + 'moff-'+cols6[i]+ '" class="dataValue">' + 
			numberWithCommas(current[cols6[i]]) + '</div></div></div>';
		}
		else if(prev[cols6[i]] == current[cols6[i]]){
			document.getElementById(cols6[i]).innerHTML = '<div class="circle" style="border-color: orange">'+
			'<div class="inner-circle" style="border-color: orange"><div style="margin-top: 30%;" id="' + 'moff-'+cols6[i]+ '" class="dataValue">' + 
			numberWithCommas(current[cols6[i]]) + '</div></div></div>';
		}
		else if(prev[cols6[i]] < current[cols6[i]]){
			document.getElementById(cols6[i]).innerHTML = '<div class="circle" style="border-color: red">'+
			'<div class="inner-circle" style="border-color: red"><div style="margin-top: 30%;" id="' + 'moff-'+cols6[i]+ '" class="dataValue">' + 
			numberWithCommas(current[cols6[i]]) + '</div></div></div>';
		}
		else if(prev[cols6[i]] > current[cols6[i]]){
			document.getElementById(cols6[i]).innerHTML = '<div class="circle" style="border-color: green">'+
			'<div class="inner-circle" style="border-color: green"><div style="margin-top: 30%;" id="' + 'moff-'+cols6[i]+ '" class="dataValue">' + 
			numberWithCommas(current[cols1[i]]) + '</div></div></div>';
		}
	}

	for(var j = 0;j<current["logisticsData"].length;j++){
		var RecordDate = new Date(current["logisticsData"][j]['RecordDate']);
		if(RecordDate.getMonth() == thisDate.getMonth() && RecordDate.getFullYear() == thisDate.getFullYear()){
			for(var i = 0;i<cols7.length;i++){
				if(current["logisticsData"][j][cols7[i]] == 'nan' && current["logisticsData"][j][cols7[i]] == ''){
					current[cols7[i]] = '-';
					prev[cols7[i]] = '-';
				}
				else{
					current[cols7[i]] = (parseFloat(current["logisticsData"][j][cols7[i]])).toFixed();
					prev[cols7[i]] = (parseFloat(current["logisticsData"][j-1][cols7[i]])).toFixed();
				}
			}
			break;
		}
			...
			for(var i = 0;i<cols7.length;i++){
				current[cols7[i]] = '-';
				prev[cols7[i]] = '-';
				current[cols7[i]+'_Date'] = thisDate;
			}
		}
	}
	for(var i = 0;i<cols7.length;i++){
		var dd = new Date(current[cols7[i]+'_Date'])
		document.getElementById('lssDate').innerHTML = '[ ' + current["months"][dd.getMonth()] + '-' + dd.getFullYear() + ' ]';
		if(current[cols7[i]] == '-'){
			document.getElementById(cols7[i]).innerHTML = '<span style="color: grey; font-size: 14pt; margin-left: 2%;"></span>'+
			'<span id="' + 'mlss-'+cols7[i]+ '" class="dataValue">' + numberWithCommas(current[cols7[i]]) + '</span>';
		}
		else if(prev[cols7[i]] == current[cols7[i]]){
			document.getElementById(cols7[i]).innerHTML = '<span style="color: orange; font-size: 14pt; margin-left: 2%;">&#9673; </span>'+
			'<span id="' + 'mlss-'+cols7[i]+ '" class="dataValue">' + numberWithCommas(current[cols7[i]]) + '</span>';
		}
		else if(prev[cols7[i]] < current[cols7[i]]){
			document.getElementById(cols7[i]).innerHTML = '<span style="color: red; font-size: 14pt; margin-left: 2%;">&#9650; </span>'+
			'<span id="' + 'mlss-'+cols7[i]+ '" class="dataValue">' + numberWithCommas(current[cols7[i]]) + '</span>';
		}
		else if(prev[cols7[i]] > current[cols7[i]]){
			document.getElementById(cols7[i]).innerHTML = '<span style="color: green; font-size: 14pt; margin-left: 2%;">&#9660; </span>'+
			'<span id="' + 'mlss-'+cols7[i]+ '" class="dataValue">' + numberWithCommas(current[cols7[i]]) + '</span>';
		}
	}
}
...
function postVisit(){
	...
	var Logoff_Time = "";
	var Page_Link = "dashboards/mrv/index.html";
	var Comment = "";
